...
namespace WebFacturaMvc.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public void MensajeErrorRegistrar(Cliente objCliente)
        {
            ...
            switch (objCliente.Estado)
            {
                ...
                case 99://carrera registrada con exito
                    ViewBag.MensajeExito = "Cliente [" + objCliente.Nombre + " " + objCliente.ApUno + "] fue Registrado en el Sistema";
                    break;
        ...
        private void mostrarMensajeEliminar(Cliente objCliente)
        {
            ...
            switch (objCliente.Estado)
            {
                ...
                case 33://CLIENTE NO EXISTE
                    ViewBag.MensajeError = "El Cliente: [" + objCliente.ApUno + " " + objCliente.ApDos + ", " + objCliente.Nombre + " ]Ya Fue Eliminado";
                    break;
                case 34:
                    ViewBag.MensajeError = "No se Puede Eliminar al Cliente [" + objCliente.ApUno + " " + objCliente.ApDos + ", " + objCliente.Nombre + "] Tiene Ventas Registrados en el Sistema!!!";
                    break;
                case 99: //EXITO
                    ViewBag.MensajeExito = "Cliente [" + objCliente.ApUno + " " + objCliente.ApDos + ", " + objCliente.Nombre + "] Fue Eliminado!!!";
                    break;
        ...
        [HttpPost]
        public ActionResult BuscarClientes(string txtnombre, string txtapuno, int txtcliente = -1)
        {
